...
namespace Proyecto.Infraestructure.Migrations
{
    ...
    [Migration("20241025201103_ActualizacionCommercialInvoice")]
    partial class ActualizacionCommercialInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Proyecto.Domain.Models.CommercialInvoice", b =>
                {
                    ...
                    b.HasOne("Proyecto.Domain.Models.ShoppingCart", "ShoppingCart")
                        .WithOne("CommercialInvoice")
                        .HasForeignKey("Proyecto.Domain.Models.CommercialInvoice", "ShoppingCartId")
