...
namespace Proyecto.Infraestructure.Migrations
{
    ...
    [Migration("20241025010307_AddCommercialInvoiceToShoppingCart")]
    partial class AddCommercialInvoiceToShoppingCart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Proyecto.Domain.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("Proyecto.Domain.Models.CommercialInvoice", "CommercialInvoice")
                        .WithOne("ShoppingCart")
                        .HasForeignKey("Proyecto.Domain.Models.ShoppingCart", "CommercialInvoiceId");
